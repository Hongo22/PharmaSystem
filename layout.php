         ...
         <span class="navbar-toggler-icon"></span>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
           <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="paciente.php">Pacientes</a>
             </li>
             <li class="nav-item">
                <a class="nav-link" href="medicamento.php">Inventario</a>
             </li>
             <li class="nav-item">
                <a class="nav-link" href="receta.php">Recetas</a>
             </li>
               <li class="nav-item">
              ...
              <li class="nav-item dropdown">
               ...
               <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="doctor.php">Lista de Doctores</a></li>
                </ul>
              </li>
             <!-- <li class="nav-item">
